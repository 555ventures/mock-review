 ...
 */
export function journeyReport(journeys: JourneyInput[], htmlOf: (screenName: string) => string | undefined): Journey[] {
  return journeys.map((journey) => {
    const unresolved: { from: number; to: number; reason: string }[] = []
